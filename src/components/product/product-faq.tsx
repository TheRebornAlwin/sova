...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Then you send it back, simple as that. You've got a full 90 days to send it back for a refund of every cent. Email us at shopsovarelief@gmail.com and you keep the bonus guide either way, with no restocking fee and no questions about why.",
  },
];
